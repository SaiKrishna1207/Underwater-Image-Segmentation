...
def data_augmentation_example(aug_dict):
    img = load_img('data/train_val/images/d_r_23_.jpg')  # this is a PIL image
    x = img_to_array(img)
    ...
    for batch in data_gen.flow(x, batch_size=1,
                               save_to_dir='aug_preview', save_prefix='example', save_format='jpg'):
        i += 1
        if i > 20:
